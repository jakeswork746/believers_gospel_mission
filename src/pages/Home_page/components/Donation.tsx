...
const Donation_involvement_section: React.FC = () => {
  return (
    <section className="flex flex-wrap items-stretch justify-center overflow-hidden my-20">
      {/* Left: Give Donations */}
      <div
        className="flex-1 min-w-[320px] text-white p-10 lg:p-16 flex flex-col justify-center items-center text-center relative"
        style={{
      ...
      >
        <div className="max-w-md">
          ...
          <p className="text-white/80 leading-relaxed mb-8 text-lg italic">
            You have two hands — one to help yourself, <br /> the second to help
            others.
          </p>
          ...
          {/* Bank Details */}
          <div className="mt-6 text-white/90 text-lg leading-relaxed bg-[#050505] py-2 px-3">
            <p className="font-semibold text-white">Account Name: <span className="font-bold text-2xl">Believers Gospel Mission</span></p> 

            <p className="font-semibold text-white">Account Number: <span className="font-bold text-2xl" >2031426615</span></p> 

            <p className="font-semibold text-white ">Bank: <span className="font-bold text-2xl" >First Bank</span></p> 
          </div>
        </div>
      ...
      <div className="flex-1 min-w-[320px] bg-[#e41e26] text-white p-10 lg:p-16 flex flex-col justify-center items-center text-center relative">
        <div className="max-w-md relative z-10">
          ...
          <p className="text-gray-200 leading-relaxed mb-8 text-lg italic">
            Together, we can reach more souls and transform more lives through
            Christ’s love.
          </p>
